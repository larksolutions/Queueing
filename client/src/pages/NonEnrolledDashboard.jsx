  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">CICS Queueing System</h1>
                <p className="text-sm text-gray-600">Non-Enrolled Student Portal</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <div className="text-right">
                ...
                <p className="text-xs text-orange-600 font-medium">Non-Enrolled Student</p>
              </div>
              <button
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Info Banner */}
        <div className="mb-8 bg-orange-50 border-2 border-orange-200 rounded-2xl p-6">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-bold text-orange-900 mb-2">Limited Access - Non-Enrolled Student</h3>
              <p className="text-orange-800 mb-3">
                As a non-enrolled student, you have access to the basic queueing system for walk-in inquiries. 
                Additional features such as appointment scheduling are available only to enrolled students.
              </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100 hover:shadow-xl transition">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-bold text-gray-900 mb-2">Join Queue</h3>
                <p className="text-gray-600 mb-4">Get in line for walk-in assistance with your concerns.</p>
                <button
                  onClick={() => navigate('/queue/join')}
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100 hover:shadow-xl transition">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-bold text-gray-900 mb-2">My Queue Status</h3>
                <p className="text-gray-600 mb-4">View your current queue position and details.</p>
                <button
...
export default NonEnrolledDashboard;
